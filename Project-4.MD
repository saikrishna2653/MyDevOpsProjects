   ...
   ---
    ...
    tasks:
     - name: stop previous version docker
       shell: docker stop department_employee || true
     - name: remove stopped container
       shell: docker rm -f department_employee || true
     - name: remove docker images
       shell: docker image rm -f saikrishna2653/department_employee || true

     - name: create docker image
       shell: docker run -d --name department_employee -p 8090:8080 saikrishna2653/department_employee
